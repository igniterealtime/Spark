...
public class PhonePlugin implements Plugin {
        ...
        SparkManager.getChatManager().addChatRoomListener(new ChatRoomListenerAdapter() {
            ...
            public void chatRoomOpened(final ChatRoom room) {
                if (room instanceof ChatRoomImpl) {
                    ...
                    try {
                        phoneEnabled = phoneClient.isPhoneEnabled(chatRoom.getParticipantJID());
                    } catch (Exception e) {
                        Log.error(e);
                    }
                    if (phoneEnabled) {
        ...
        contactList.addContextMenuListener(new ContextMenuListener() {
            ...
            public void poppingUp(Object object, final JPopupMenu popup) {
                if (object instanceof ContactItem) {
                    ...
                    // Add call action to contact popup
                    if (phoneEnabled) {
    ...
    private void displayRingUI(RingEvent event) {
        ...
        displayIncomingCallNotification(incomingCall);
    }
    ...
    public void callJID(final BareJid jid) {
        final Runnable caller = () -> {
            try {
    ...
    private class PhoneListener implements BasePhoneEventListener {
        @Override
