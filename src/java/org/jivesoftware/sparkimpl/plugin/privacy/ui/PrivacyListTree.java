...
public class PrivacyListTree extends JPanel {
    ...
    /**
     * If the selceted Node is a GroupNode (TreeItems "Contacts" and "Groups"
	...
	if (node.getPrivacyList().getListName().equals(PrivacyManager.getInstance().getBlackList().getListName())) return;
