...
public class JContactItemFieldTest {
    ...
    @Test
    public void validateCharsChecksWholeString() {
        assertTrue(JContactItemField.validateChars("john.doe@example.com"));
        assertFalse(JContactItemField.validateChars("bad#name"));
        assertFalse(JContactItemField.validateChars(""));
    }
}
