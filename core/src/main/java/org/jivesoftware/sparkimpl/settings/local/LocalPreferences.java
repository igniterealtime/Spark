...
/**
 * Application preferences (from the "spark.properties").
 */
public class LocalPreferences {
    ...
    /**
     * Returns the XMPP Port to communicate on. Default is 5222.
     */
    public int getXmppPort() {
        return getInt("xmppPort", Default.getInt(Default.XMPP_PORT));
    }
    ...
    public String getGroupChatPassword(String roomName) {
        String propVal = getString(roomName);
        return !isBlank(propVal) ? Encryptor.decrypt(propVal) : null;
    }
    ...
    public int getTimeOut() {
        return getInt("timeout", Default.getInt(Default.TIME_OUT));
    }
    ...
    public int getReconnectDelay() {
        return getInt("reconnectDelay", 10);
    }

    public void setReconnectDelay(int reconnectDelay) {
        setInt("reconnectDelay", reconnectDelay);
    }
    ...
    public void clearPasswordForAllUsers() {
        findPropertyNamesForStoredPasswords().forEach(props::remove);
    }

    /**
     * Find the name of all properties that store a password.
     */
    private List<String> findPropertyNamesForStoredPasswords() {
        List<String> passwordProps = new ArrayList<>();
        for (var prop : props.entrySet()) {
            ...
            String jidPart = name.substring("password".length());
            try {
                JidCreate.bareFrom(Encryptor.decryptOrThrow(jidPart));
                passwordProps.add(name);
            } catch (Exception ignored) {
                // Skip properties with invalid JID
                continue;
            }
        }
    ...
    public boolean isIdleOn() {
        return getBoolean("idleOn", true);
    }

    public void setIdleOn(boolean idleOn) {
        setBoolean("idleOn", idleOn);
    }
    ...
    public ConnectionConfiguration.SecurityMode getSecurityMode() {
        try {
            String securityMode = getString("securityMode", Default.getString(Default.SECURITY_MODE));
    ...
    public String getProxyUsername() {
        return getString("proxyUsername");
    }

    public void setProxyUsername(String proxyUsername) {
        setString("proxyUsername", proxyUsername);
    }
    ...
    public void setProxyPassword(String proxyPassword) {
        setString("proxyPassword", proxyPassword);
    }
    ...
    public String getXmppHost() {
        return getString("xmppHost");
    }

    public void setXmppHost(String xmppHost) {
        setString("xmppHost", xmppHost);
    }
    ...
    public String getResource() {
        return getString("resource", Default.getString(Default.SHORT_NAME));
    }
    ...
    public int getFileTransferTimeout() {
        return getInt("fileTransferTimeout", 30);
    }

    public void setFileTransferTimeout(int minutes) {
        setInt("fileTransferTimeout", minutes);
    }

    public void setChatLengthDefaultTimeout(int minutes) {
        setInt("defaultChatLengthTimeout", minutes);
    }

    public int getChatLengthDefaultTimeout() {
        return getInt("defaultChatLengthTimeout", 15);
    }

    public void setNickname(Resourcepart nickname) {
        setString("nickname", nickname.toString());
    }

    public Resourcepart getNickname() {
        String nicknameString = getString("nickname");
        return Resourcepart.fromOrThrowUnchecked(!isBlank(nicknameString) ? nicknameString : SparkManager.getUserManager().getNickname());
    }
    ...
    public void setEmoticonPack(String pack) {
        setString("emoticonPack", pack);
    }

    public String getEmoticonPack() {
        return getString("emoticonPack", "Default");
    }
    ...
    public String getLookAndFeel() {
        var lafProp = getString("LookAndFeel");
        if (!isBlank(lafProp)) {
            return lafProp;
        }
    ...
    public void setSSORealm(String realm) {
        setString("ssoRealm", realm);
    }

    public String getSSORealm() {
        return getString("ssoRealm");
    }

    public void setSSOKDC(String kdc) {
        setString("ssoKDC", kdc);
    }
    ...
    public void setAudioSystem(String device) {
        setString("audioSystem", device);
    }

    public String getAudioSystem() {
        return getString("audioSystem", "wasapi");
    }

    public void setAudioDevice(String device) {
        setString("audioDevice", device);
    }

    public String getAudioDevice() {
        return getString("audioDevice", "javasound://");
    }

    public void setPlaybackDevice(String device) {
        setString("playbackDevice", device);
    }

    public String getPlaybackDevice() {
        return getString("playbackDevice", "javasound://");
    }

    public void setVideoDevice(String device) {
        setString("videoDevice", device);
    }

    public String getVideoDevice() {
        return getString("videoDevice");
    }
    ...
    private int getInt(String property, int defaultValue) {
        String propertyVal = props.getProperty(property);
        return propertyVal != null ? Integer.parseInt(propertyVal) : defaultValue;
    }
    ...
    public EntityBareJid getDefaultBookmarkedConf() {
        var jidString = getString("defaultBookmarkedConf");
        if (isBlank(jidString)) {
            return null;
        }
    ...
    public void setDeactivatedPlugins(List<String> list) {
        ...
        if (!list.isEmpty()) {
            String liste = list.toString().substring(1, list.toString().length() - 1);
            liste = liste.replace(", ", ",");
    ...
    public void setPswdAutologin(boolean ccPswdAutologin) {
        setBoolean("ccPswdAutologin", ccPswdAutologin);
    }
    ...
    public void setAcceptSelfSigned(boolean acceptSelfSigned) {
        setBoolean("acceptSelfSigned", acceptSelfSigned);
    }
    ...
    public void setAcceptRevoked(boolean acceptRevoked) {
        setBoolean("acceptRevoked", acceptRevoked);
    }
    ...
    public void setAcceptExpired(boolean acceptExpired) {
        setBoolean("acceptExpired", acceptExpired);
    }
    ...
    public void setAcceptNotValidYet(boolean acceptNotValidYet) {
        setBoolean("acceptNotValidYet", acceptNotValidYet);
    }
    ...
    public void setCheckOCSP(boolean checkOCSP) {
        setBoolean("checkOCSP", checkOCSP);
    }
    ...
    public void setAllowSoftFail(boolean allowSoftFail) {
        setBoolean("allowSoftFail", allowSoftFail);
    }
    ...
    public void setAllowClientSideAuthentication(boolean allowClientSideAuthentication) {
        setBoolean("allowClientSideAuthentication", allowClientSideAuthentication);
    }
