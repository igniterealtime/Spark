...
public class RssTransport implements Transport {
	...
	public String getInstructions() {
        return Res.getString("message.enter.rss");
    }

    @Override
	public Icon getIcon() {
        return SparkRes.getImageIcon(SparkRes.Icon.RSS_TRANSPORT_ACTIVE_IMAGE);
    }

    @Override
	public Icon getInactiveIcon() {
        return SparkRes.getImageIcon(SparkRes.Icon.RSS_TRANSPORT_INACTIVE_IMAGE);
    }
