...
public class MatrixTransport extends Transport {
	...
	public String getInstructions() {
        return Res.getString("message.enter.matrix");
    }

    @Override
	public Icon getIcon() {
        return SparkRes.getImageIcon(SparkRes.Icon.MATRIX_TRANSPORT_ACTIVE_IMAGE);
    }

    @Override
	public Icon getInactiveIcon() {
        return SparkRes.getImageIcon(SparkRes.Icon.MATRIX_TRANSPORT_INACTIVE_IMAGE);
    }
