...
public class WhatsappTransport extends Transport {
	...
	public String getInstructions() {
        return Res.getString("message.enter.whatsapp");
    }

    @Override
	public Icon getIcon() {
        return SparkRes.getImageIcon(SparkRes.Icon.WHATSAPP_TRANSPORT_ACTIVE_IMAGE);
    }

    @Override
	public Icon getInactiveIcon() {
        return SparkRes.getImageIcon(SparkRes.Icon.WHATSAPP_TRANSPORT_INACTIVE_IMAGE);
    }
