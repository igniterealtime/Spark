...
//        }
    ...
    private final class LoginPanel extends JPanel implements KeyListener, ActionListener, FocusListener, CallbackHandler {
        ...
        LoginPanel() {
            ...
            // <editor-fold desc="Apply string resources to components">
            // Apply string resources to components
            ...
            // <editor-fold desc="Set up container layout">
            ...
            // <editor-fold desc="Handle arguments">
            // Handle arguments
         ...
         */
        private void setComponentsAvailability(boolean available) {
        ...
        private void validateLogin() {
            final SwingWorker loginValidationThread = new SwingWorker() {
                ...
                public Object construct() {
                    ...
                    boolean loginSuccessful = beforeLoginValidations() && login();
                    if (loginSuccessful) {
                        afterLogin();
